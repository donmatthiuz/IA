...
from functions import MonteCarloLearnStateValueFunction, evaluate_policy_success_rate
...
# Política aleatoria
updated_policy = (1 / env.action_space.n) * np.ones((env.observation_space.n, env.action_space.n))

# Evaluar la tasa de éxito
success_rate = evaluate_policy_success_rate(env, updated_policy, num_episodes=1000)
